...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="login_success">
			<div class="login_bj">
				<div class="succ">
					<img src="${pageContext.request.contextPath}/com/lbt/front/images/login_success.jpg" />
				</div>
				<h5>
					${loginUser.nickname }，欢迎加入当当网
				</h5>
				<h6>
					请牢记您的登录邮件地址：${loginUser.email }
				</h6>
				<h6>
				...
				<ul>
					...
					<li>
						<a href="${pageContext.request.contextPath}/front/main">浏览并选购商品</a>
					</li>
				</ul>
			</div>
		</div>
