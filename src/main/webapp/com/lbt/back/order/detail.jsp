  ...
  <div align=center style="font-size:25px">订单详细信息</div><hr/>
  	 <table bordercolor='#898E90' align='center' border='3px' cellpadding='5px' cellspacing="0px">
          ...
          <c:forEach var="i" items="${itemlist}">
			<tr align='center'> 
				 <td>${i.name }</td>
				 <td style="width: 100px;"><img style="width:32px;height: 20px" src="${pageContext.request.contextPath }/com/lbt/back/images/${i.cover}"></td>
				 <td style="width: 180px;">单价：¥${i.price }</td>
				 <td style="width: 200px;">当当价：¥${i.dprice }</td>
