	...
	<form action="${pageContext.request.contextPath}/book/UpdateBook" method="post" enctype="multipart/form-data">
			<table>
				...
				<input type="hidden" name="book.id"  value="${book.id}">
				 <input type="hidden" name="book.creat_date"  value="${book.create_date}">
				...
				<tr>
					...
					<td>
						<select name="book.category_id" class="el-select__inner inner2" >
							...
							<c:forEach var="b" items="${firstCategoryList }">
				...
				<tr>
					...
					<td rowspan="3">
						<label id="file_upload1_label" for="file_upload1">
							<img id="uploadimg" src="${pageContext.request.contextPath }/com/lbt/back/images/${book.cover}" alt="" width="120px" height="145px" />
						</label> 
				...
				<tr>
					...
					<td>编辑推荐：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.editior_recommend" >${book.editior_recommend}</textarea></td>
				</tr>
				<tr>
					<td>出版社：</td>
