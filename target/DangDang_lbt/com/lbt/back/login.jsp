...
<title>登录 - 当当网</title>
<link href="${pageContext.request.contextPath }/com/lbt/back/css/login.css" rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath }/com/lbt/back/css/pop_cheat.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${pageContext.request.contextPath }/com/lbt/back/js/jquery-3.3.1.js"></script>
...
<body>
	<div class="head">
		<div class="improve">
			<img src="${pageContext.request.contextPath }/com/lbt/back/images/bz.jpg" width="178" height="61" />
		</div>
	</div>
	...
	<div class="login_bg" style="width:960px; margin:0 auto;">
		...
		<div id="J_cheatProofTop" class="new_tip">
			...
			<div>为保障账放大户安全，请勿设置与邮箱及其他网站相同的账户登录密码或支付密码，<a href="javascript:;">谨防诈骗</a>！</div>
		</div>
		
		<div class="set_area clearfix">
			<div class="wrap clearfix">
				<div id="J_loginDiv">
					<form action="${pageContext.request.contextPath }/admin/LoginAction" method="post">
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
											<img id="imgVcode" src="${pageContext.request.contextPath}/admin/getCode" class="Ucc_captcha Captcha-image" onClick="changeImage()">
										</a>
