...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="login_success">
			<div class="login_bj">
				<div class="succ">
					<img src="${pageContext.request.contextPath }/com/lbt/front/images/order_success.jpg" />
				</div>
				<h5>
					订单已经生成
				</h5>
				<h6>
					您刚刚生成的订单号是：<font color="red"><strong>${order_name }</strong></font>，
					金额总计<font color="red"><strong>${total }</strong></font>
				</h6>

				<ul>
					<li class="nobj">
						您现在可以：还有<font color="red"><strong id="ss">5</strong></font>秒,回到首页！！！
					</li>
					<li>
